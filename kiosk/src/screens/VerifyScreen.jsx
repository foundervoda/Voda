  ...
  return (
    <div className={`rounded-2xl border-2 ${s.border} ${s.bg} p-5 flex items-center gap-4 transition-all duration-300`}>
      ...
      <div className="text-right shrink-0">
        <p className="text-navy/30 text-[10px] uppercase tracking-widest mb-0.5">Barcode</p>
        <p className="font-mono font-bold text-navy/70 text-sm tracking-widest">{item.variant.scanCode}</p>
      </div>
    </div>
  )
}
